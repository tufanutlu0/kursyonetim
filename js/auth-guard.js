...
// Rol -> Yönlendirme haritası (RELATİF — her yerde çalışır)
const ROLE_HOME = {
  admin: "admin.html",
  mudur: "admin.html",       // Aynı panel, muhasebe gizli
    ...
    onAuthStateChanged(auth, async (user) => {
      ...
      if (currentPage === "login.html") {
        if (user) {
          ...
          if (profile) window.location.href = ROLE_HOME[profile.role] || "login.html";
        }
